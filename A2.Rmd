...
$p$ Represents the probability of the event of interest occurring, such as voting for a specific candidate or party. It's the proportion of times you expect the event (like voting for a particular option) to occur out of all possible outcomes.
