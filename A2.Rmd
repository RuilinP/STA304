...
survey_income <- survey_data1 %>% ggplot(aes(x = income, fill = income)) + 
  ...
  labs(x = "Income level of the household", y = "Frequency", title = "Histogram of the level of the income (survey)")

census_income <- census_data1 %>% ggplot(aes(x = income, fill = income)) + 
  geom_bar() + theme_classic() +
  labs(x = "Income level of the household", y = "Frequency", title = "Histogram of of the level of the income (census")
