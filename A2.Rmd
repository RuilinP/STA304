...
knitr::kable(vote_table, caption = "Table 1.Statistics about the proportions of Yes votes for the Liberal and the Conservative in Survey data", align = "cccc", digits = 4)
```
Table 1 shows that 
...
summary_sur_age <- survey_data1 %>% summarise(
                                  ...
                                  mean = mean(age), 
                                  sd = sd(age)) 
knitr::kable(summary_sur_age, caption = "Table 2.Statistics about the ages of voters in 2021 election survey data", align = "cccc", digits = 2)
...
summary_cen_age <- census_data1 %>% summarise(
                                  ...
                                  mean = mean(age), 
                                  sd = sd(age))
knitr::kable(summary_cen_age, caption = "Table 3.Statistics about the ages of voters in 2021 election census data", align = "cccc", digits = 2)
...
knitr::kable(list(summary_survey_sex, summary_census_sex), position = c("left", "right"), caption = "Table 4.Statistics about the frequency and proportion of male and female voters in 2021 election survey and cenus data", align = "cccc", digits = 2)
```
Table 4 shows
...
knitr::kable(list(summary_survey_language, summary_census_language), position = c("left", "right"), caption = "Table 5.Statistics about the frequency and proportion of French and English speaking voters in 2021 election survey and cenus data", align = "cccc", digits = 2)
```
Table 5 shows
