...
survey_west <- survey_data1 %>% ggplot(aes(x = west, fill = west)) + 
  ...
  theme_classic() +
  labs(x = "Whether the people that participated\n in the election are from the western provinces", y = "Frequency", title = "Histogram of the whether the election\n participants are in western\n provinces from survey") +
  theme(plot.title = element_text(size = 14, hjust = 0.5)) +
